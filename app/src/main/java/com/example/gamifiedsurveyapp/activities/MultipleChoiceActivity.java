...
public class MultipleChoiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // check if there are more than 2 options given, and adjust view and layout accordingly
        if (mQuestion.getChoice3().equals("null")){
            choice3.setVisibility(View.GONE);
        } else {
            choice3.setText(mQuestion.getChoice3());
        }

        if (mQuestion.getChoice4().equals("null")){
            choice4.setVisibility(View.GONE);
        } else {
            choice4.setText(mQuestion.getChoice4());
        }

        if (mQuestion.getChoice5().equals("null")){
            choice5.setVisibility(View.GONE);
        } else {
            choice5.setText(mQuestion.getChoice5());
        }
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (questionsAnsweredInThisLevel == questionsToAnswerThisLevel) {
                    ...
                    intent = new Intent(MultipleChoiceActivity.this, LevelSelectActivity.class);
                } else if (mSurvey.getNextQuestionType() == 1) {
                    intent = new Intent(MultipleChoiceActivity.this, StarRatingActivity.class);
                } else if (mSurvey.getNextQuestionType() == 2) {
                    intent = new Intent(MultipleChoiceActivity.this, LikertAgreeActivity.class);
                } else if (mSurvey.getNextQuestionType() == 3) {
                    intent = new Intent(MultipleChoiceActivity.this, LikertHappyActivity.class);
                } else if (mSurvey.getNextQuestionType() == 4) {
                    intent = new Intent(MultipleChoiceActivity.this, TextInputActivity.class);
                } else {
